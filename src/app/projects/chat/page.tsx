...
export const metadata: Metadata = {
  ...
  description: "Real-time chat application using WebSocket and React. Learn how to build scalable messaging systems with Socket.io and Node.js.",
  keywords: "chat application, WebSocket, Socket.io, real-time messaging, React, Node.js",
};
