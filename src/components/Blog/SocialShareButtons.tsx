  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-3">
        {shareButtons.map((button) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-white ${button.bgColor} transition-all duration-200 transform hover:scale-105 active:scale-95 shadow-md hover:shadow-lg`}
      ...
      <p className="mt-4 text-sm text-neutral-600 dark:text-neutral-400">
        Help others discover this content by sharing it on your favorite social
        platform!
      </p>
    </>
  );
